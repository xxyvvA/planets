        ...
        <div className={styles.information}>
          {planetView === "geology" ? (
            <div className={styles.abomination}>
              <img className={styles.planet} src={planet.images.planet} alt="Neptune" />
              <img
                className={styles.geology}
                src={planet.images[planetView]}
                alt="geological view of Neptune"
              />
            </div>
          ) : (
            <img className={styles.planet} src={planet.images[planetView]} alt="Neptune" />
          )}
          <Information
            name={planet.name}
            planet={planets[7]}
