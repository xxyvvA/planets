        ...
        <div className={styles.information}>
          {planetView === "geology" ? (
            <div className={styles.abomination}>
              <img className={styles.planet} src={planet.images.planet} alt="Venus" />
              <img
                className={styles.geology}
                src={planet.images[planetView]}
                alt="geological view of Venus"
              />
            </div>
          ) : (
            <img className={styles.planet} src={planet.images[planetView]} alt="Venus" />
          )}
          <Information
            name={planet.name}
            planet={planets[1]}
